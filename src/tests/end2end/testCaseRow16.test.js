...
describe('ROGERS Mock Email Test using MailSlurp', () => {
  test('Should send email to ROGERS if LPDS_ID found expire or NoFootPrint in Firestore', async () => {
    const sendEmailToRogers = async () => {
      ...
      const parsedResult = await queryPartnerDB('TPSP07');
      ...
      return new Promise((resolve, reject) => {
        const newAmsMap = '123 Moonwalk st, Rogers Mock Address City NL, CA';
        //const province = 'NL';
    ...
    const sendEmailResponse = await sendEmailToRogers();
